...
import com.pasantias.redriapp.adapters.ProyectosAdapter;
...
public class ProyectoActivity extends AppCompatActivity {
        ...
        service.getProyectos().enqueue(new Callback<List<Proyecto>>() {
            ...
            public void onResponse(@NonNull Call<List<Proyecto>> call, @NonNull Response<List<Proyecto>> response) {
                try {
                    ...
                    Toast.makeText(ProyectoActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void showRegister(View view){
        startActivityForResult(new Intent(this, RegisterProyectoActivity.class), REQUEST_REGISTER_FORM);
    }
